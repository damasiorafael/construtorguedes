...
<body>
    ...
    <script type="text/javascript">
        function initializeMaps() {
            var myLatlng = new google.maps.LatLng(-23.508394,-51.236847);
            var latlngAlpha = new google.maps.LatLng(-23.508394,-51.236847);
            var mapOptions = {
              zoom: 15,
              center: myLatlng,
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-detalhes-contato">
                <p class="item-contato">
                    <abbr title="Address">
                        <b>
                            <span>Rua Sebastião Cardoso da Silva, 30</span>
                            <span>Distrito São Luiz | CEP: 86117-000 | londrina - PR</span>
                        </b>
                    </abbr>
                </p>
                <br />
                <p class="item-contato">
                    ...
                    <abbr title="Phone">
                        <span>(43) 9836-1777</span>
                        <span>(43) 9910-9419</span>
                        <span>(43) 3398-9173</span>
                    </abbr>
                </p>
                <br />
                <p class="item-contato">
                    ...
                    <abbr title="Email">
                        <span>construtor.guedes@outlook.com</span>
                    </abbr>
                </p>
            </div>
        </div>
